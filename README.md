...
1. [**Build a QnA copilot with prompt flow in Azure AI Studio (Optional):**](/Student/Challenge-02.md) Discover how to create a responsive QnA system using prompt flow, allowing for intuitive and efficient user interactions with your AI solutions.
